...
public class JsonDtoParserTest {
    ...
    protected final static String MESSAGE_PROGRESS = "{\"id\":\"16156359002\",\"content\":{\"value\":1,\"state\":{\"enumType\":\"com.zipwhip.outgoing.TransmissionState\",\"name\":\"QUEUED\"},\"key\":\"fb853ba8-7f43-47a5-a136-82b0010e0ac8\"},\"scope\":\"device\",\"reason\":null,\"tag\":null,\"event\":\"messageProgress\",\"class\":\"com.zipwhip.signals.Signal\",\"uuid\":\"2147bc3b-9ab4-4f35-98ea-80a3e4ca2d09\",\"type\":\"messageProgress\",\"uri\":\"/signal/messageProgress/messageProgress\"}";
    ...
    @Test
    public void testParseMessageProgress() throws Exception {
        MessageProgress dto = parser.parseMessageProgress(new JSONObject(MESSAGE_PROGRESS).optJSONObject("content"));
        Assert.assertNotNull(dto);
        Assert.assertEquals(dto.getKey(), "fb853ba8-7f43-47a5-a136-82b0010e0ac8");
    }
