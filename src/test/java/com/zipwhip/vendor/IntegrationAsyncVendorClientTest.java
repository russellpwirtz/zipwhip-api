...
//        NetworkFuture<Void> result = client.textlineProvision("2066810884");
...
//        NetworkFuture<Void> result = client.textlineEnroll("2066810884", "amoothart@zipwhip.com");
//        Assert.assertNotNull(result);
//        result.await();
//        Assert.assertTrue(result.isSuccess());
    }
...
//        NetworkFuture<Void> result = client.textlineUnenroll("2066810884");
//        Assert.assertNotNull(result);
//        result.await();
//        Assert.assertTrue(result.isSuccess());
    }
